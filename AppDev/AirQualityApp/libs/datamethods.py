...
def refresh_data(data_directory):
    ...
    while True:
        ...
        if not glob.glob(pfilepattern):
            print("ERROR: No processed data .pkl files exist in the chosen directory.")
            message = "ERROR: No processed data .pkl files exist in the chosen directory."
            break
            # raise Exception("No processed data .pkl files exist in the chosen data directory.")
        else:
